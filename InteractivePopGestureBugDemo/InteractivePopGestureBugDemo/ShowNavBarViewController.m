...
@interface ShowNavBarViewController ()

@property (nonatomic, strong) UIButton *button;

@end

@implementation ShowNavBarViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"ShowNavBarViewController";
...
- (UIButton *)button {
    if (!_button) {
        ...
        _button.frame = CGRectMake(30, 94, 60, 60);
    }
    return _button;
}
